...
def split_data_by_days(data, val_days, test_days, interval=5):
    '''
    :param data: [B, *]
    :param val_days:
    :param test_days:
    :param interval: interval (5, 15, 30, 60) minutes
    :return:
    '''
    T = int((24*60)/interval + 1e-3)
    val_days = int(val_days + 1e-3)
    test_days = int(test_days + 1e-3)
...
if __name__ == '__main__':
    ...
    train_dataloader, val_dataloader, test_dataloader, scaler = get_dataloader(args,
                                                                               normalizer='std', tod=False, dow=False,
